...
const TString lumiString = "CMS Preliminary";
...
double data[nEtaBins] = {
  7.82418e-01, 7.21202e-01, 8.70166e-01, 8.62935e-01, 8.64639e-01, 8.71175e-01, 7.21293e-01, 7.75896e-01 
};

// statistical only errors 
double dataErrStat[nEtaBins] = {
  1.81193e-03, 1.68341e-03, 1.19130e-03, 6.24151e-04, 6.14923e-04, 1.20576e-03, 1.69089e-03, 1.80859e-03 
};

// MC efficiencies and errors - C&C
double mc[nEtaBins] = {
  0.759485, 0.705377, 0.868945, 0.867263, 0.864374, 0.867451, 0.705276, 0.765044
};
